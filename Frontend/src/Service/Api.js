...
const getUser = () => axios.get(`${URI}/user/all`, { headers })
...
const getCartCount=(id)=>axios.get(`${URI}/order/getUserCount/${id}`,{headers})
...
export { getProduct, getProductbyId, addProduct, editProduct, deleteProduct, getProductCount, getFeedback, addFeedback, deleteFeedback, getFeedbacktCount, getUser, getUserbyId, editUser, deleteUser, getUserCount, adminLogin,userLogin,userRegister,addCart,getCart,getOrderCount,deleteCartItem,getCartCount }
